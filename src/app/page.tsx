          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">"UCONtransit</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line">UCON Nourish</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
