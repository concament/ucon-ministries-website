...
`}</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 animate-fade-in">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <Badge className="mb-4 !whitespace-pre-line !tracking-[10px]">Our Core Values</Badge>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-xl !whitespace-pre-line !whitespace-pre-line">Ucon Awaken</CardTitle>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">"UCON Transit</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">UCON Nourish</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">UCON Neighbors</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="!whitespace-pre-line !whitespace-pre-line">UCON Voice</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
          ...
          <div className="mb-12">
            <Card className="border-2 border-[#A92FFA]/30 hover-lift">
              ...
              <CardContent className="space-y-6 text-lg !w-[495px] !h-[1022px]">
                ...
                <p className="text-muted-foreground leading-relaxed !whitespace-pre-line !w-[915px] !h-[272px] !whitespace-pre-line">{``}
