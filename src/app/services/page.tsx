      ...
      <section id="workshops" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 relative h-80 rounded-lg overflow-hidden">
            <Image
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/3b399b69-78b1-47ea-a46d-f78b0232d98b/generated_images/professional-photograph-of-workshop-or-c-8d22fc30-20251025022559.jpg"
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden double-exposure">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 relative h-96 rounded-lg overflow-hidden">
            <Image
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/3b399b69-78b1-47ea-a46d-f78b0232d98b/generated_images/inspiring-photo-of-diverse-group-of-peop-7bcab182-20251025022559.jpg"
              alt="Bible study community gathering"
              fill
              className="object-cover"
            />
          </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="pastoral" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Add Pastoral Care Image */}
          <div className="mb-12 relative h-80 rounded-lg overflow-hidden">
            <Image
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/3b399b69-78b1-47ea-a46d-f78b0232d98b/generated_images/warm-photograph-of-counselor-or-pastor-m-1388b84f-20251025022559.jpg"
              alt="Pastoral counseling session"
              fill
              className="object-cover"
            />
          </div>
