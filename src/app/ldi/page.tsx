              ...
              <Card className={`col-span-2 bg-gradient-to-br from-[#A92FFA]/5 to-[#F28C28]/5 transition-all duration-700 delay-600 ${
                ...
                <CardHeader>
                  <CardTitle className="text-sm flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#A92FFA]" />
                    What's Included
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <CardContent className="pt-12 pb-12">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  <Button size="lg" variant="outline" className="bg-white text-[#A92FFA] hover:bg-white/90 border-white text-lg px-8">
                    <FileText className="w-5 h-5 mr-2" />
                    Apply Now
                  </Button>
                  <Button size="lg" variant="outline" className="bg-white text-[#F28C28] hover:bg-white/90 border-white text-lg px-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 text-left">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/80">(555) 555-1234</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/80">123 Hope St, CA 90210</p>
                      </div>
                    </div>
                  </div>
                </div>
