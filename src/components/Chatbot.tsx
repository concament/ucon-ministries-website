...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hey there friend! I'm Hope, and I'm here to help you learn about UCon Ministries, answer questions bout our programs, and assist with registration. How can I help you today? 😊",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: 'assistant',
        content: "Oh friend, I'm havin some trouble connecting right now. Can you try again in a bit? Or feel free to call us at (555) 555-1234 - we always here to help! 🙏",
        timestamp: new Date()
      };
    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-16 w-16 rounded-full shadow-2xl bg-gradient-to-br from-[#A92FFA] to-[#F28C28] hover:scale-110 transition-transform z-50 animate-bounce"
          aria-label="Chat with Hope"
        >
          ...
          <CardHeader className="pb-3 bg-gradient-to-br from-[#A92FFA] to-[#F28C28] text-white rounded-t-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-lg">Hope</CardTitle>
                  <p className="text-xs text-white/80">UCon Ministries Assistant</p>
                </div>
              </div>
              <Button
